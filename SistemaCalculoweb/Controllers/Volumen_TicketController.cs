...
namespace SistemaCalculoweb.Controllers
{
    public class Volumen_TicketController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Sugerencia,Descripcion,Referencia,HH")] Volumen_Ticket volumen_Ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Sugerencia,Descripcion,Referencia,HH")] Volumen_Ticket volumen_Ticket)
        {
            if (ModelState.IsValid)
            {
