...
namespace SistemaCalculoweb.Controllers
{
    public class TipoOperacionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idTipoOperacion,descripcion,estado")] TipoOperacion tipoOperacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idTipoOperacion,descripcion,estado")] TipoOperacion tipoOperacion)
        {
            if (ModelState.IsValid)
            {
